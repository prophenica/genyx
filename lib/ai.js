...
- DEPOIMENTOS: use nomes COMPLETAMENTE DIFERENTES e VARIADOS a cada geracao. Nunca repita nomes como Mariana, Beatriz, Juliana, Lucas. Use nomes incomuns, de diferentes regioes do Brasil, misture generos. Exemplo: Renata, Fabio, Giovana, Thiago, Isabela, Marcos, Leticia, Bruno, Yasmin, Diego.

Responda APENAS com JSON valido e sem markdown:

{
  ...
  "testimonials": [
    { "name": "nome unico e incomum", "role": "tipo de cliente especifico", "city": "cidade brasileira", "text": "depoimento especifico e credivel" },
    { "name": "nome diferente do anterior", "role": "tipo de cliente diferente", "city": "cidade diferente", "text": "depoimento completamente diferente" },
    { "name": "nome diferente dos anteriores", "role": "tipo de cliente diferente", "city": "cidade diferente", "text": "depoimento completamente diferente" }
  ],
  "cta_section": {
